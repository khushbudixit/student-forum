...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="fl_left">
        ...
        <h1><a href="#"><p  style="font-size:30px;color:white;font-weight:bold;text-transform:capitalize;">Reva Student Forum</p></a></h1><br>
     <h1><a href="#"><p  style="font-size:22px;color:blue;font-weight:bold;text-transform:capitalize;">LOGIN HERE</p></a></h1>
    </div>
    <!--
